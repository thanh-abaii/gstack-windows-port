...
$B screenshot $env:TEMP\after-login.png
```
...
$B screenshot $env:TEMP\prod-check.png
```
...
$B snapshot -i -a -o $env:TEMP\feature-annotated.png
...
$B goto https://yourapp.com
$B responsive $env:TEMP\layout

# Manual: specific viewport
$B viewport 375x812     # iPhone
$B screenshot $env:TEMP\mobile.png
$B viewport 1440x900    # Desktop
$B screenshot $env:TEMP\desktop.png

# Element screenshot (crop to specific element)
$B screenshot "#hero-banner" $env:TEMP\hero.png
$B snapshot -i
$B screenshot @e3 $env:TEMP\button.png

# Region crop
$B screenshot --clip 0,0,800,600 $env:TEMP\above-fold.png

# Viewport only (no scroll)
$B screenshot --viewport $env:TEMP\viewport.png
```
...
$B screenshot $env:TEMP\upload-result.png
```
...
$B snapshot -i
$B screenshot $env:TEMP\github-profile.png
```
...
echo '[
  ...
  ["click","@e5"],
  ["snapshot","-D"],
  ["screenshot","$env:TEMP\result.png"]
]' | $B chain
```
