...
preamble-tier: 1
version: 1.0.0
description: Turn any markdown file into a publiGet-Contention-quality PDF. (gstack)
triggers:
  - markdown to pdf
  - generate pdf
  - make pdf
...
# make-pdf: publiGet-Contention-quality PDFs from markdown
...
### PubliGet-Contention mode — cover + TOC + chapter breaks
