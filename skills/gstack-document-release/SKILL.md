...
```bash
python "bin/gstack-boot.py" --skill document-release | iex
```
...
```bash
Remove-Item -Force $env:TEMP\gstack-pr-body-$$.md
```
...
- Already bumped — version was set by /gs:ship
