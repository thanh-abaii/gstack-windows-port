...
```bash
python "bin/gstack-boot.py" --skill pair-agent | iex
```
...
# /gs:pair-agent — Share Your Browser With Another AI Agent
...
```bash
which ngrok | Out-Null ; echo "NGROK_INSTALLED" ; echo "NGROK_NOT_INSTALLED"
ngrok config check | Out-Null ; echo "NGROK_AUTHED" ; echo "NGROK_NOT_AUTHED"
```
